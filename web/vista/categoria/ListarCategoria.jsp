        ...
        <div class="table-responsive">
            ...
            <table class="table table-bordered" style="width: 800px;">
                ...
                <% for(int i=0; i<list1.size();i++){
                    ...
                    categoria = (Categoria)list1.get(i);
                    %>
                <tr>
                    ...
                    <td>
                        <a href="categ?op=3&id=<%= categoria.getIdcat()%>" class="btn btn-mini btn-primary" role="button">Editar</a>
                        <a href="categ?op=6&id=<%= categoria.getIdcat()%>" class="btn btn-mini btn-primary" role="button">Eliminar</a>
                    </td>
                </tr>
                <%}%>
            </table>
